...
<div class="page-breadcrumb">
  <div class="row">
    <div class="col-12 d-flex no-block align-items-center">
      <h4 class="page-title">Pengaturan galeri</h4>
            ...
            <table id="myTable" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$g->name}}</td>
                  <td>
                    <img class="rounded" src="/assets/images/gallery/{{$image}}" style="width: 100px; aspect-ratio:16/9; object-fit: cover;">
                  </td>
                  @php
                    $date = date_create($g->created_at);
                  @endphp
                  <td>{{date_format($date,"d M Y")}}</td>
                  <td>
                    <button type="button" class="btn btn-info btn-icon" data-toggle="modal" data-target="#edit" onclick="edit({{$g->id}})"><i class="mdi mdi-pencil"></i></button>
                    <button type="button" class="btn btn-danger btn-icon" data-toggle="modal" data-target="#hapus" onclick="hapus({{$g->id}})"><i class="fa fa-times"></i></button>
                  </td>
                </tr>
                @endforeach
              </tbody>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog"aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="et">Edit galeri</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form" method="post" action="">
        ...
        <div class="modal-body">
          <p id="hd">Apakah anda yakin ingin menghapus foto ini?</p>
        </div>
        <div class="modal-footer">
          <button type="reset" class="btn btn-secondary me-3" data-dismiss="modal">Batal</button>
