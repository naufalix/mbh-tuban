...
<div class="page-breadcrumb">
  <div class="row">
    <div class="col-12 d-flex no-block align-items-center">
      <h4 class="page-title">Pengaturan karya</h4>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Data karya</h5>
            ...
            <table id="myTable" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$c->name}}</td>
                  <td>
                    <img class="rounded" src="/assets/images/craft/{{$image}}" style="width: 100px; aspect-ratio:16/9; object-fit: cover;">
                  </td>
                  @php
                  ...
                  <td>
                    <button type="button" class="btn btn-info btn-icon" data-toggle="modal" data-target="#edit" onclick="edit({{$c->id}})"><i class="mdi mdi-pencil"></i></button>
                    <button type="button" class="btn btn-danger btn-icon" data-toggle="modal" data-target="#hapus" onclick="hapus({{$c->id}})"><i class="fa fa-times"></i></button>
                  </td>
                </tr>
                @endforeach
              </tbody>
    ...
    <div class="modal-content">
      ...
      <form class="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="row mb-2">
            <div class="col-12">
              <label class="required fw-bold mb-2">Gambar karya</label>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog"aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="et">Edit karya</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form" method="post" action="">
        ...
        <div class="modal-body">
          <p id="hd">Apakah anda yakin ingin menghapus karya ini?</p>
        </div>
        <div class="modal-footer">
          <button type="reset" class="btn btn-secondary me-3" data-dismiss="modal">Batal</button>
