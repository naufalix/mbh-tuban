  ...
  <div class="scroll-sidebar">
    ...
    <nav class="sidebar-nav">
      <ul id="sidebarnav" class="p-t-20">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/admin/facility" aria-expanded="false">
            <i class="fas fa-building"></i><span class="hide-menu">Fasilitas</span>
          </a>
        </li>
        <li class="sidebar-item">
